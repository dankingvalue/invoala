...
<div class="sheet">
  ...
  <!-- No "Made with Invoala" footer here: client statements are already a
       Pro/Teams-only feature (requireProFeature "client_statement"), so
       every statement is generated by a paying account. -->
</div>
</body>
</html>`;
}
