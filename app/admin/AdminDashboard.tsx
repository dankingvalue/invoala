...
export function AdminDashboard({ myRole, myId }: { myRole: string; myId: string }) {
    ...
    return (
      <Panel>
        <div className="flex max-h-[calc(100vh-120px)] flex-col">
          ...
          <ConversationHeaderExtras conv={selectedConv} myRole="admin" myId={myId} incident={incident} onUpdated={() => loadConversation(selectedConv)} />
